package com.naturenine.utils.chipcloud;
...
public class ChipCloud extends FlowLayout implements ChipListener {
    ...
    public static class Configure {
        ...
        public void deselectChip(int index,String text)
        {
            Chip chip = (Chip) chipCloud.getChildAt(index);
            if(text.equals(chip.getText()))
            {
                chip.deselect();
            }
        }
